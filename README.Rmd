...
For help on writing **tldr** documentation, see the [**tldr** repo](https://github.com/jamesotto852/tldr).
...
see [**tldrExample**](https://github.com/jamesotto852/tldr) for an example of a package with **tldr** documentation.
